// Code generated by protoc-gen-go / protoc-gen-go-grpc. DO NOT EDIT.
//
// Vendored from sing-box v1.13.12 experimental/v2rayapi (stats.proto). Only the
// Go package name was changed (v2rayapi -> v2raystats); the proto service path
// "/experimental.v2rayapi.StatsService/..." is preserved verbatim so this client
// hits the gRPC service our self-built sing-box (-tags with_v2ray_api) serves.
