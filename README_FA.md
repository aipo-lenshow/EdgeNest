...
**ساخت با جادوگر: سناریوی موردنظر را انتخاب کنید — EdgeNest مجموعه پروتکل‌ها را از پیش انتخاب کرده و شما را به ساخت سریع می‌برد.**

![ساخت ورودی بر اساس سناریو](docs/screenshots/01-create-inbound-scenarios.jpg)

**هر ۱۱ پروتکل ورودی در یک نگاه: محبوبیت، نیاز به دامنه، پشتیبانی CDN / Argo و تاب‌آوری شبکه.**

![راهنمای پروتکل‌ها](docs/screenshots/02-protocol-guide.jpg)

**مسیریابی دسته‌ای با یک کلیک: ترافیک را بر اساس دسته سرویس (هوش مصنوعی / استریم / ابزار توسعه‌دهنده و غیره) به خروجی درست هدایت کنید.**

![قوانین مسیریابی](docs/screenshots/03-routing-rules.jpg)

**اشتراک برای هر کلاینت: کلاینت‌هایی را که از آن‌ها اشتراک می‌گیرید انتخاب کنید — EdgeNest هرکدام را با فرمت خودش می‌سازد، اتصال هنگام وارد کردن.**

![انتخاب کلاینت‌ها](docs/screenshots/04-clients.jpg)
...
| `EDGENEST_VERSION` | `1.12.0624` | نسخه‌ای که برای دانلود نسخه از پیش ساخته‌شده استفاده می‌شود |
